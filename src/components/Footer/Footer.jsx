        ...
        <div className="grid grid-cols-4 w-full h-[400px] px-[50px] pt-[30px]">
          ...
          <div className="mt-[50px]">
            <div className="mx-auto text-white">
              ...
              <ul className="list-disc pl-[12px] list-inside space-y-4">
                <li className="text-2xl">Add Popular Post</li>
                <li className="text-2xl">Add Popular Post</li>
                <li className="text-2xl">Add Popular Post</li>
              </ul>
            </div>
          ...
          <div className="mt-[50px]">
            <div className="mx-auto text-white">
              <h2 className="text-4xl font-bold mb-6">Popular Category</h2>
              <ul className="list-disc pl-[12px] list-inside space-y-4">
                <li className="text-2xl">Add Popular Category</li>
                <li className="text-2xl">Add Popular Category</li>
                <li className="text-2xl">Add Popular Category</li>
              </ul>
            </div>
